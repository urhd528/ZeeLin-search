...
```json
{
  ...
  "Zeelin_Api_Url": "https://skills.zeelin.cn:5000/api/es/search/natural",
  "Zeelin_Api_Key": ""
}
```
...
1. 先在对话中展示前5条结果的预览（使用上面的美观格式），数据来源为api接口返回
...
3️⃣  填写配置文件
   ...
   ```json
   {
     ...
     "Zeelin_Api_Url": "http://skills.zeelin.cn:5000/api/es/search/natural",
